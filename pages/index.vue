      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="container-dados">
          <h2 class="text-xl font-[700] text-gray-700 mb-4 flex items-center">
            <Icon name="ph:handshake" size="32px" class="mr-2 text-fb-500" />
            Total de Feedbacks
          </h2>
        ...
        <div class="container-dados">
          <div v-for="fb in feedbacksStore.feedbacksPorStatus" :key="fb.status" class="text-gray-600 mb-2 flex items-center">
            ...
            <span class="text-xl ">{{ fb.status }}s</span> 
          </div>
        </div>

        <div class="container-dados">
          <p class="text-xl font-semibold text-gray-700 mb-2 sm:mb-4">Setor campeão de elogios: </p>
        ...
        <div class="container-dados">
          <p class="text-xl font-semibold text-gray-700 mb-2 sm:mb-4">Setor com maior nº de sugestões: </p>
        ...
        <div class="container-dados">
          <p class="text-xl font-semibold text-gray-700 mb-2 sm:mb-4">Setor mais criticado: </p>
        ...
        <div class="container-dados">
          <h2 class="text-xl font-semibold text-gray-700 mb-4">Feedbacks por Tipo</h2>
          <ul>
        ...
        <div class="container-dados">
          <h2 class="text-xl font-semibold text-gray-700 mb-4">Feedbacks por Setor</h2>
          <ul>
